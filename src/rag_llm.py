...
def longchain_magic(vectorstore):
    ...
    system_prompt = """You are an AI Assistant specialized in providing accurate information about Jose Agustin BARRACHINA. Only respond when the question explicitly asks for information. 
Keep your answers factual, and based solely on the information provided. Do not speculate or fabricate details. 
